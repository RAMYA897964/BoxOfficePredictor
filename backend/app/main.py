...
#model = joblib.load("../model/final_xgb_model.joblib")
#scaler = joblib.load("../model/standard_scaler.joblib")  # scaler should be trained on BudgetUSD, One_Week_SalesUSD, IMDbRating
